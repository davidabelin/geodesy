# c:\Users\David\Documents\Local_Data\WashDC\walk_kml.py
import xml.etree.ElementTree as ET
import os

# --- Configuration ---
# Use a raw string (r'...') for Windows paths to handle backslashes correctly
kml_file_path = r'c:\Users\David\Documents\Local_Data\WashDC\data\centerpnts.kml'
#\Triangle Tries.kml'
# --- End Configuration ---
...
if extracted_points:
    ...
    for point in extracted_points:
        print(f"\"{point['name']}\",{point['coordinates'][0]},{point['coordinates'][1]},\"\"")    
