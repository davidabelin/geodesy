...
kml_file_path = 'dc_avenues.kml' # Choose our output KML path
...
for feature in geojson_data.get('features', []):
    ...
    # (Alternatively, we could create shared styles if many routes have the same color)
    style = simplekml.Style()
    style.linestyle.color = kml_color
    style.linestyle.width = 1 # Set line width (adjust as needed)
    ...
    if geom_type == "LineString":
        ...
        placemark.extrude = 1 # Typically 0 for roads, 1 can make it stand up slightly
